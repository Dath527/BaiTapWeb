...
<form method="post" class="form"> 
    ...
    <table class="table">
        ...
        <?php
            $tk = $_SESSION['tk'];
            $sql="SELECT DISTINCT * FROM hoadon WHERE tk LIKE '%$tk%' ORDER BY ID DESC LIMIT $firstRow, $rowsPerPage";
                    ...
                    echo 'class="row2"'; ?>>
                            ...
                            <td><div class="cell3" onclick="window.location.href = 'trangchu.php?page_layout=chitiet&ID=<?php echo $row['ID']?>'"> Chi tiết</div></td>
                    </tr>
                    <?php
                    }
        ?> 
